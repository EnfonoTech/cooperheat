...
Replace `cooperheat`, `cooperheat`, `KSA` placeholders.

---

```markdown
# cooperheat — Claude Code Instructions
...
bench export-fixtures --app cooperheat       # after Custom Field changes
bench --site <site> run-tests --app cooperheat  # run all tests
